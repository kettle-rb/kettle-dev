...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency("turbo_tests2", "~> 3.2", ">= 3.2.1")           # ruby >= 2.4.0, default kettle-test runner
  ...
  spec.add_development_dependency("gitmoji-regex", "~> 2.0", ">= 2.0.5")            # ruby >= 2.4
end
