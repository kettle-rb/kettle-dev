...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency("kettle-gha-pins", "~> 0.3", ">= 0.3.13")           # ruby >= 2.4.0
  spec.add_dependency("kettle-ndjson", "~> 0.1", ">= 0.1.12")             # ruby >= 2.4.0
  spec.add_dependency("kettle-rb", "~> 0.1", ">= 0.1.10")                  # ruby >= 1.8.7
