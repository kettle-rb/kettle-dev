...
# This is a multi-line footer template comment attached to code.

example_method("goo", "jar")

# This is a single-line template comment that should remain relatively placed.

example_method("hoo", "car")

# This is a template single-line method attached above lines of code.
example_method("foo", "bar")
example_method("moo", "tar")
# This is a template single-line comment attached below lines of code.

# This is a "postamble" template comment.
